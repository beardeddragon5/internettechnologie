 ...
 * 
 */
@WebServiceClient(name = "WeatherService", targetNamespace = "http://itt.matthias_ramsauer.de/", wsdlLocation = "http://localhost:8080/weather?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEATHERSERVICE_QNAME = new QName("http://itt.matthias_ramsauer.de/", "WeatherService");
    ...
    public Weather getWeatherPort() {
        return super.getPort(new QName("http://itt.matthias_ramsauer.de/", "WeatherPort"), Weather.class);
    }
    ...
    public Weather getWeatherPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://itt.matthias_ramsauer.de/", "WeatherPort"), Weather.class, features);
    }
